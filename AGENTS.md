...
Recent examples of the right loop: `CharacterSheet` / loot, `playerMeleeNearest`, InputMap short-tap latch, particles/quests on `SceneContext`, `autoWinOnClear: false` for multi-area games.
